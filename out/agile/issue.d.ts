...
export declare class Issue {
    ...
    getIssue<T = unknown>(parameters: Parameters.GetIssue, callback: Callback<T>): Promise<void>;
    /**
       * Returns a single issue, for a given issue ID or issue key.
       *  Issues returned from this resource include Agile fields, like sprint, closedSprints, flagged, and epic.  */
    getIssue<T = unknown>(parameters: Parameters.GetIssue, callback?: never): Promise<T>;
    /**
