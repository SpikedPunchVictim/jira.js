...
export declare class Epic {
    ...
    /**
       ...
       *
       *  <b>Note:</b> This operation does not work for epics in next-gen projects.  */
    getEpic<T = unknown>(parameters: Parameters.GetEpic, callback: Callback<T>): Promise<void>;
    /**
       * Returns the epic for a given epic ID. This epic will only be returned if the user has permission to view it.
       *
       *  <b>Note:</b> This operation does not work for epics in next-gen projects.  */
    getEpic<T = unknown>(parameters: Parameters.GetEpic, callback?: never): Promise<T>;
    /**
       ...
       *
       *  <b>Note:</b> This operation does not work for epics in next-gen projects.  */
    partiallyUpdateEpic<T = unknown>(parameters: Parameters.PartiallyUpdateEpic, callback: Callback<T>): Promise<void>;
    /**
       * Performs a partial update of the epic.
       *  A partial update means that fields not present in the request JSON will not be updated.
       *  Valid values for color are <code>color_1</code> to <code>color_9</code>.
       *
       *  <b>Note:</b> This operation does not work for epics in next-gen projects.  */
    partiallyUpdateEpic<T = unknown>(parameters: Parameters.PartiallyUpdateEpic, callback?: never): Promise<T>;
    /**
