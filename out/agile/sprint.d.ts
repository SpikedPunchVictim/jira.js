...
export declare class Sprint {
    ...
    /**
       ...
       *  </p>  */
    createSprint<T = unknown>(parameters: Parameters.CreateSprint | undefined, callback: Callback<T>): Promise<void>;
    /**
       * Creates a future sprint. Sprint name and origin board id are required. Start date, end date, and goal are optional.
       *
       *  <p>
       ...
       *  call is ignored and instead the last sprint's duration is used to fill the form.
       *  </p>  */
    createSprint<T = unknown>(parameters?: Parameters.CreateSprint, callback?: never): Promise<T>;
    /**
    ...
    getSprint<T = unknown>(parameters: Parameters.GetSprint, callback: Callback<T>): Promise<void>;
    /**
       * Returns the sprint for a given sprint ID. The sprint will only be returned if the user can view the board
       *  that the sprint was created on, or view at least one of the issues in the sprint.  */
    getSprint<T = unknown>(parameters: Parameters.GetSprint, callback?: never): Promise<T>;
    /**
       ...
       *  </ul>  */
    partiallyUpdateSprint<T = unknown>(parameters: Parameters.PartiallyUpdateSprint, callback: Callback<T>): Promise<void>;
    /**
       * Performs a partial update of a sprint.
       *  A partial update means that fields not present in the request JSON will not be updated.
       *  <p>Notes:</p>
       ...
       *  <li>The completeDate field cannot be updated manually.</li>
       *  </ul>  */
    partiallyUpdateSprint<T = unknown>(parameters: Parameters.PartiallyUpdateSprint, callback?: never): Promise<T>;
    /**
       ...
       *  <li>The completeDate field cannot be updated manually.</li>
       *  </ul>  */
    updateSprint<T = unknown>(parameters: Parameters.UpdateSprint, callback: Callback<T>): Promise<void>;
    /**
       * Performs a full update of a sprint.
       *  A full update means that the result will be exactly the same as the request body.
       *  Any fields not present in the request JSON will be set to null.
       ...
       *  <li>The completeDate field cannot be updated manually.</li>
       *  </ul>  */
    updateSprint<T = unknown>(parameters: Parameters.UpdateSprint, callback?: never): Promise<T>;
    /**
    ...
    getIssuesForSprint<T = unknown>(parameters: Parameters.GetIssuesForSprint, callback: Callback<T>): Promise<void>;
    /**
       * Returns all issues in a sprint, for a given sprint ID. This only includes issues that the user has permission to view.
       *  By default, the returned issues are ordered by rank.  */
    getIssuesForSprint<T = unknown>(parameters: Parameters.GetIssuesForSprint, callback?: never): Promise<T>;
    /**
