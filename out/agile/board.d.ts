...
export declare class Board {
    ...
    /**
       ...
       *  </li>
       *  </ul>  */
    createBoard<T = Models.CreateBoard>(parameters: Parameters.CreateBoard | undefined, callback: Callback<T>): Promise<void>;
    /**
       * Creates a new board. Board name, type and filter ID is required.
       *  <ul>
       *  <li><code>name</code> - Must be less than 255 characters.</li>
    ...
    getEpics<T = unknown>(parameters: Parameters.GetEpics, callback: Callback<T>): Promise<void>;
    /**
       * Returns all epics from the board, for the given board ID. This only includes epics that the user has permission to view.
       *  Note, if the user does not have permission to view the board, no epics will be returned at all.  */
    getEpics<T = unknown>(parameters: Parameters.GetEpics, callback?: never): Promise<T>;
    /**
       * Returns all issues that do not belong to any epic on a board, for a given board ID.
       *  This only includes issues that the user has permission to view.
       *  Issues returned from this resource include Agile fields, like sprint, closedSprints, flagged, and epic.
       *  By default, the returned issues are ordered by rank.  */
    getIssuesWithoutEpicForBoard<T = unknown>(parameters: Parameters.GetIssuesWithoutEpicForBoard, callback: Callback<T>): Promise<void>;
    /**
       * Returns all issues that do not belong to any epic on a board, for a given board ID.
       *  This only includes issues that the user has permission to view.
       *  Issues returned from this resource include Agile fields, like sprint, closedSprints, flagged, and epic.
       *  By default, the returned issues are ordered by rank.  */
    getIssuesWithoutEpicForBoard<T = unknown>(parameters: Parameters.GetIssuesWithoutEpicForBoard, callback?: never): Promise<T>;
    /**
       * Returns all issues that belong to an epic on the board, for the given epic ID and the board ID.
       *  This only includes issues that the user has permission to view.
       *  Issues returned from this resource include Agile fields, like sprint, closedSprints, flagged, and epic.
       *  By default, the returned issues are ordered by rank.  */
    getBoardIssuesForEpic<T = unknown>(parameters: Parameters.GetBoardIssuesForEpic, callback: Callback<T>): Promise<void>;
    /**
       * Returns all issues that belong to an epic on the board, for the given epic ID and the board ID.
       *  This only includes issues that the user has permission to view.
       *  Issues returned from this resource include Agile fields, like sprint, closedSprints, flagged, and epic.
       *  By default, the returned issues are ordered by rank.  */
    getBoardIssuesForEpic<T = unknown>(parameters: Parameters.GetBoardIssuesForEpic, callback?: never): Promise<T>;
    /**
       *   */
    ...
    /**
       ...
       *  Epic issues do not belongs to the scrum boards.
       *  </p>  */
    getProjects<T = unknown>(parameters: Parameters.GetProjects, callback: Callback<T>): Promise<void>;
    /**
       * Returns all projects that are associated with the board, for the given board ID.
       *  If the user does not have permission to view the board, no projects will be returned at all.
       *  Returned projects are ordered by the name.
       ...
       *  Epic issues do not belongs to the scrum boards.
       *  </p>  */
    getProjects<T = unknown>(parameters: Parameters.GetProjects, callback?: never): Promise<T>;
    /**
       ...
       *  but query <code>project in (ABC, BCD) OR reporter = admin</code> doesn't have reference to any project.
       *  </p>  */
    getProjectsFull<T = unknown>(parameters: Parameters.GetProjectsFull, callback: Callback<T>): Promise<void>;
    /**
       * Returns all projects that are statically associated with the board, for the given board ID.
       *  Returned projects are ordered by the name.
       *  </p>
       ...
       *  but query <code>project in (ABC, BCD) OR reporter = admin</code> doesn't have reference to any project.
       *  </p>  */
    getProjectsFull<T = unknown>(parameters: Parameters.GetProjectsFull, callback?: never): Promise<T>;
    /**
    ...
    getAllSprints<T = unknown>(parameters: Parameters.GetAllSprints, callback: Callback<T>): Promise<void>;
    /**
       * Returns all sprints from a board, for a given board ID. This only includes sprints that the user has permission to view.  */
    getAllSprints<T = unknown>(parameters: Parameters.GetAllSprints, callback?: never): Promise<T>;
    /**
    ...
    getAllVersions<T = unknown>(parameters: Parameters.GetAllVersions, callback: Callback<T>): Promise<void>;
    /**
       * Returns all versions from a board, for a given board ID. This only includes versions that the user has permission to view.
       *  Note, if the user does not have permission to view the board, no versions will be returned at all.
       *  Returned versions are ordered by the name of the project from which they belong and then by sequence defined by user.  */
    getAllVersions<T = unknown>(parameters: Parameters.GetAllVersions, callback?: never): Promise<T>;
}
