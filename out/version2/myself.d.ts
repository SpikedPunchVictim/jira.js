...
export declare class Myself {
    ...
    getPreference<T = unknown>(parameters: Parameters.GetPreference, callback: Callback<T>): Promise<void>;
    /**
       * Returns the value of a preference of the current user.
       *
       * Note that these keys are deprecated:
       ...
       *
       * **[Permissions](#permissions) required:** Permission to access Jira. */
    getPreference<T = unknown>(parameters: Parameters.GetPreference, callback?: never): Promise<T>;
    /**
