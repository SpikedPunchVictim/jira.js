...
export declare class Groups {
    ...
    removeGroup<T = unknown>(parameters: Parameters.RemoveGroup, callback: Callback<T>): Promise<void>;
    /**
       * Deletes a group.
       *
       * **[Permissions](#permissions) required:** Site administration (that is, member of the *site-admin* strategic [group](https://confluence.atlassian.com/x/24xjL)). */
    removeGroup<T = unknown>(parameters: Parameters.RemoveGroup, callback?: never): Promise<T>;
    /**
