...
export declare class IssueWorklogs {
    ...
    getWorklogsForIds<T = unknown>(parameters: Parameters.GetWorklogsForIds | undefined, callback: Callback<T>): Promise<void>;
    /**
       * Returns worklog details for a list of worklog IDs.
       *
       * The returned list of worklogs is limited to 1000 items.
       ...
       *  *  the worklog is set as *Viewable by All Users*.
       *  *  the user is a member of a project role or group with permission to view the worklog. */
    getWorklogsForIds<T = unknown>(parameters?: Parameters.GetWorklogsForIds, callback?: never): Promise<T>;
    /**
